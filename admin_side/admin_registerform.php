...
<script>
    ...
    <body>
        ...
        <section class="outer">
            <div class="container">
                <form action="./php_processes/process_admin_registration.php" method="POST" onsubmit="return validateForm()">
                    ...
                    <div class="flex-container">
                        ...
                        <div class="flex-item">
                            ...
                            <input type="tel" id="phone" name="phone" required placeholder="09123456789" maxlength="11" pattern="[0-9]{11}"><br>    
                        </div>
                    </div>
                    <hr>
                    <div class="flex-item">
                        ...
                        <input type="text" id="username" name="username" required placeholder="juan_DC"><br>
                    </div>
                    <div class="flex-item">
