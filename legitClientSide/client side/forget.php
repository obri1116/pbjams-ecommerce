...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["email"])) {
    ...
    $user = array();
    $query = "SELECT first_name, last_name FROM clients WHERE email = ?";
    ...
    if ($stmt->affected_rows > 0) {
        ...
        $mail->Body = "<p>Dear <strong>" . htmlspecialchars($full_name) . "</strong>,</p>" .
              ...
              // CHANGE DIRECTORY
              "<p><a href='localhost/works/primary/legitClientSide/ResetPassword.php?token=" . urlencode($token) . "'>Reset Your Password</a></p>" .
              // CHANGE DIRECTORY
